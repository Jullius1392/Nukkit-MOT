...
public interface BlockID {
    ...
    int RESIN_BRICKS = 1268;
    int RESIN_BRICK_SLAB = 1269;
    int RESIN_BRICK_DOUBLE_SLAB = 1270;
    int RESIN_BRICK_STAIRS = 1271;
    int RESIN_BRICK_WALL = 1272;
    int OPEN_EYEBLOSSOM = 1273;
    ...
    int COPPER_CHEST = 1286;
    int EXPOSED_COPPER_CHEST = 1287;
    int WEATHERED_COPPER_CHEST = 1288;
    int OXIDIZED_COPPER_CHEST = 1289;
    int WAXED_COPPER_CHEST = 1290;
    int WAXED_EXPOSED_COPPER_CHEST = 1291;
    int WAXED_WEATHERED_COPPER_CHEST = 1292;
    int WAXED_OXIDIZED_COPPER_CHEST = 1293;
    ...
    int WAXED_LIGHTNING_ROD = 1317;
    int WAXED_EXPOSED_LIGHTNING_ROD = 1318;
    int WAXED_WEATHERED_LIGHTNING_ROD = 1319;
    int WAXED_OXIDIZED_LIGHTNING_ROD = 1320;
    int COPPER_BARS = 1321;
    int EXPOSED_COPPER_BARS = 1322;
    int WEATHERED_COPPER_BARS = 1323;
    int OXIDIZED_COPPER_BARS = 1324;
    int WAXED_COPPER_BARS = 1325;
    int WAXED_EXPOSED_COPPER_BARS = 1326;
    int WAXED_WEATHERED_COPPER_BARS = 1327;
    int WAXED_OXIDIZED_COPPER_BARS = 1328;
    int COPPER_CHAIN = 1329;
    int EXPOSED_COPPER_CHAIN = 1330;
    int WEATHERED_COPPER_CHAIN = 1331;
    int OXIDIZED_COPPER_CHAIN = 1332;
    int WAXED_COPPER_CHAIN = 1333;
    int WAXED_EXPOSED_COPPER_CHAIN = 1334;
    int WAXED_WEATHERED_COPPER_CHAIN = 1335;
    int WAXED_OXIDIZED_COPPER_CHAIN = 1336;
    int COPPER_TORCH = 1337;
    int COPPER_LANTERN = 1338;
    int EXPOSED_COPPER_LANTERN = 1339;
    int WEATHERED_COPPER_LANTERN = 1340;
    int OXIDIZED_COPPER_LANTERN = 1341;
    int WAXED_COPPER_LANTERN = 1342;
